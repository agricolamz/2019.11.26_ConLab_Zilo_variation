...
## Zilo questionary (`r length(unique(zilo_experiment$speaker_id))` speakers)
...
(@third) 'third girl'
(@verb1) 'On the wedding the bride were beautiful'
(@plural_heel) 'heels'
...
* *odoruk’a* 'butterfly' (@butterfly_sg, @butterfly_pl) is one of the most variable words from [@moroz19]

## Zilo questionary (`r length(unique(zilo_experiment$speaker_id))` speakers): dative

(@dative_father, @dative_cow)



## Zilo questionary (`r length(unique(zilo_experiment$speaker_id))` speakers): agreement

(@parents)

## Zilo questionary (`r length(unique(zilo_experiment$speaker_id))` speakers): plural forms

We obserced some variability in plural forms formation, but stimuli selected for this topic (@plural_heel, @plural_soninlow) were not variable at all...

## Zilo questionary (`r length(unique(zilo_experiment$speaker_id))` speakers): verb

Samira, say something about (@verb1, @verb2, @verb3), please


## Zilo questionary (`r length(unique(zilo_experiment$speaker_id))` speakers): lexics
