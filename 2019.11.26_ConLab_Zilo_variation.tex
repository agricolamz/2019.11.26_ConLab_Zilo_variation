...
\hypersetup{
  pdftitle={Catching variation during fieldwork on Nakh-Daghestanian languages},
  pdfauthor={George Moroz, Samira Verhees},
  hidelinks,
...
\tightlist
\item
  44 Zilo speakers (Upper Andic, Northeast Caucasian) during the
  fieldwork in 2019
\end{itemize}
...
\tightlist
\item
  and 23 Nakh-Daghestanian researches via online questionary
\end{itemize}
